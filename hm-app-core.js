...
// 网络请求
angular.module('hmAppCore').factory("HttpAuth", ['$rootScope', 'Storage', 'authService', '$q', '$http', function ($rootScope, Storage, authService, $q, $http) {
  initJWTListener();
  var authHttp = {};
  ...
  function refreshToken() {
    ...
    authHttp.post(
      HMConfig.GATEWAYURL + 'api/authenticate',
...
// BlankCtrl
angular.module('hmAppCore').controller('BlankCtrl', ['$scope', '$ionicHistory', function ($scope, $ionicHistory) {
